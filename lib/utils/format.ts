 ...
 */
export function parseFormInteger(
    value: string,
    defaultValue: number = 0
): number {
 ...
 * @returns Formatted string like "2h30" or "45min"
 */
...
/**
 * Format duration in hours with decimals
 * @param minutes - Duration in minutes
 * @returns Formatted string like "2.5h"
 */
export function formatDureeDecimal(minutes: number): string {
