 ...
 */
export async function getEntreprisePlan(
    entrepriseId: string
): Promise<PlanType> {
 ...
 */
export async function checkCanAddDocument(
    entrepriseId: string
): Promise<boolean> {
    const now = new Date();
 ...
 */
export async function checkCanAddSegment(
    entrepriseId: string
): Promise<boolean> {
 ...
 */
export async function checkCanAddAutomation(
    entrepriseId: string
): Promise<boolean> {
