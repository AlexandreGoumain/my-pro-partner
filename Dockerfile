...
# Force reinstall lightningcss to ensure native binaries are correctly installed
RUN npm uninstall lightningcss && npm install lightningcss --save-dev --legacy-peer-deps
