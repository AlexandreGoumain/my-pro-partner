...
export function RepairStatusBadge({ statut, className }: RepairStatusBadgeProps) {
  const getStatusConfig = (status: StatutReparation) => {
    const configs = {
      DEPOSE: {
        label: "Déposé",
    ...
    return configs[status] || configs.DEPOSE;
  };
