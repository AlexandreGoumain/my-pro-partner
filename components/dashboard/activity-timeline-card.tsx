...
import { Clock, FileText, User, CreditCard, Package, Megaphone } from "lucide-react";
...
export function ActivityTimelineCard({ activities, className }: ActivityTimelineCardProps) {
    // Icon mapping
    const typeIcons = {
        client: User,
        document: FileText,
            ...
            <div className="space-y-4">
                {activities.length === 0 ? (
                    <div className="text-center py-8">
                        <Clock className="w-8 h-8 text-black/10 mx-auto mb-3" strokeWidth={2} />
                        <p className="text-[13px] text-black/30">Aucune activité récente</p>
                    </div>
                ) : (
                                ...
                                <div className="space-y-1">
                                    ...
                                    <div className="flex items-start justify-between gap-2">
                                        <div className="flex items-start gap-2 flex-1 min-w-0">
                                            <div className={`flex-shrink-0 p-1.5 rounded-md ${colors.bg} mt-0.5`}>
                                                <Icon className={`w-3 h-3 ${colors.icon}`} strokeWidth={2} />
                                            </div>
