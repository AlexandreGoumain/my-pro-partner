...
import { Trophy, User, Package } from "lucide-react";
...
export function TopPerformersCard({ topPerformers, className }: TopPerformersCardProps) {
            ...
            <Tabs defaultValue="clients" className="w-full">
                <TabsList className="grid w-full grid-cols-2 mb-4 bg-black/5 p-1 rounded-md h-auto">
                    ...
                    <TabsTrigger
                        ...
                        className="text-[13px] data-[state=active]:bg-white data-[state=active]:text-black text-black/60 py-2"
                    >
                        <Package className="w-3.5 h-3.5 mr-1.5" strokeWidth={2} />
                        Produits
                    </TabsTrigger>
                </TabsList>
                ...
                <TabsContent value="clients" className="mt-0 space-y-3">
                    {clients.length === 0 ? (
                        <div className="text-center py-8">
                            <p className="text-[13px] text-black/30">Aucun client</p>
                        </div>
                    ) : (
                ...
                <TabsContent value="products" className="mt-0 space-y-3">
                    {products.length === 0 ? (
                        <div className="text-center py-8">
                            <p className="text-[13px] text-black/30">Aucun produit</p>
                        </div>
                    ) : (
