...
import { Activity, TrendingUp, Users, ShoppingCart, Package } from "lucide-react";
...
export function BusinessHealthScore({ health, className }: BusinessHealthScoreProps) {
    const { score, level, factors } = health;
