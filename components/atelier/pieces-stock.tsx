...
export function PiecesStock() {
  ...
  return (
    <div className="space-y-4">
      {/* Search */}
      <div className="group relative overflow-hidden bg-white border border-black/[0.08] rounded-lg p-4 hover:shadow-lg hover:shadow-black/5 transition-all duration-300">
          ...
          <Table>
            ...
            <TableBody>
              {pieces.map((piece: any) => (
                <TableRow key={piece.id} className="hover:bg-black/[0.02] transition-colors">
        ...
        <div className="grid grid-cols-3 gap-5">
          <div className="group relative overflow-hidden bg-white border border-black/[0.08] rounded-lg p-6 hover:shadow-lg hover:shadow-black/5 transition-all duration-500">
            ...
            <div className="relative">
              <div className="flex items-center gap-2 mb-3">
                ...
                <p className="text-[13px] font-medium tracking-[-0.01em] text-black/60">Pièces en stock</p>
              </div>
          ...
          <div className="group relative overflow-hidden bg-white border border-black/[0.08] rounded-lg p-6 hover:shadow-lg hover:shadow-black/5 transition-all duration-500">
            ...
            <div className="relative">
              <div className="flex items-center gap-2 mb-3">
                <div className="w-1 h-4 bg-gradient-to-b from-black to-black/40 rounded-full" />
                <p className="text-[13px] font-medium tracking-[-0.01em] text-black/60">Quantité totale</p>
              </div>
              <p className="text-[28px] font-bold tracking-[-0.02em] text-black">
                {pieces.reduce(
          ...
          <div className="group relative overflow-hidden bg-white border border-black/[0.08] rounded-lg p-6 hover:shadow-lg hover:shadow-black/5 transition-all duration-500">
            ...
            <div className="relative">
              <div className="flex items-center gap-2 mb-3">
                <div className="w-1 h-4 bg-gradient-to-b from-black to-black/40 rounded-full" />
                <p className="text-[13px] font-medium tracking-[-0.01em] text-black/60">Valeur totale</p>
              </div>
              <p className="text-[28px] font-bold tracking-[-0.02em] text-black">
                {pieces
                  .reduce(
