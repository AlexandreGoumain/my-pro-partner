...
export function CategoryTreeView({
    ...
    return (
        <CardSection
            ...
            description="Cliquez sur les flèches pour déplier/replier • Survolez pour voir les actions • Catégories et sous-catégories uniquement"
            icon={FolderTree}
            badge={
            ...
            {isLoading ? (
                ...
                <div className="text-center py-16">
                    ...
                    <p className="text-muted-foreground mb-6 max-w-md mx-auto">
                        Créez votre première catégorie principale pour commencer
                        à organiser vos produits et services
                    </p>
