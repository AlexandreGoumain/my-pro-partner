                ...
                <div className="space-y-4 pt-2">
                    {options.map((option) => {
                        ...
                        return (
                            <div
                                key={option.slug}
                                className="border border-black/[0.08] rounded-lg p-6 hover:border-black/[0.12] hover:shadow-sm transition-all duration-200"
                            >
