            ...
            <Card className="max-w-2xl w-full border-amber-200 bg-amber-50/50">
                ...
                <CardContent className="space-y-6">
                    <p className="text-[15px] text-black/70 leading-relaxed">
                        Les paiements ne sont pas encore configurés. Pour
                        activer les abonnements, vous devez configurer vos
                    ...
                    <div className="bg-white border border-black/10 rounded-lg p-5 space-y-4">
                        ...
                        <p className="text-[14px] text-black/60 ml-8">
                            Rendez-vous sur votre dashboard Stripe et créez 3
                            produits (STARTER, PRO, ENTERPRISE) avec leurs prix
                            mensuels et annuels.
                        </p>
                        <Button
                            asChild
                    ...
                    <div className="bg-white border border-black/10 rounded-lg p-5 space-y-4">
                        ...
                        <p className="text-[14px] text-black/60 ml-8">
                            Copiez les Price IDs de chaque prix créé et
                            ajoutez-les dans votre fichier{" "}
                            <code className="px-1.5 py-0.5 bg-black/5 rounded text-[13px] font-mono">
                                .env
                            </code>
                        </p>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex-1">
                                <p className="text-[14px] text-black/70">
                                    Besoin d&apos;aide ? Consultez le guide de
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        <p className="text-[13px] text-blue-900">
                            💡 <strong>Astuce :</strong> Utilisez le mode test
                            de Stripe (clés commençant par{" "}
                            <code className="px-1 bg-blue-100 rounded">
                                sk_test_
                            </code>
                            ) pour le développement. Vous pourrez basculer en
