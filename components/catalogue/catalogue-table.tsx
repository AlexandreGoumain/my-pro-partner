        ...
        <Table>
          ...
          <TableBody>
            {articles.map((article: Article) => (
              <TableRow key={article.id} className="hover:bg-black/2">
                ...
                {type === "OCCASION" && (
                  <TableCell className="text-[13px] text-black/60 text-right">
                    {article.rachat?.prixRachat ? Number(article.rachat.prixRachat).toFixed(2) : "-"} €
                  </TableCell>
                )}
                {type === "PIECE" && (
                  <TableCell className="text-[13px] text-black/60">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      <DropdownMenuItem asChild>
                        <Link href={`/dashboard/catalogue/${article.id}`}>
