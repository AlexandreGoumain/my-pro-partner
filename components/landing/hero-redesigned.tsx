...
export function HeroRedesigned() {
    ...
    return (
        <section
            ref={heroRef}
            className="relative min-h-[100vh] flex items-center justify-center px-6 sm:px-8 overflow-hidden bg-white"
        >
                    ...
                    >
                        ...
                        <div className="space-y-6">
                            ...
                            <p className="text-[20px] sm:text-[22px] text-black/60 leading-[1.5] max-w-[580px] font-normal">
                                Devis, factures, clients, stocks. L&apos;IA
                                s&apos;occupe de tout.
                                <span className="text-black font-semibold">
                                    {" "}
                                    Vous, occupez-vous de vos clients.
                                </span>
                            </p>
                        </div>
                        ...
                        <div className="flex items-center gap-6 pt-2">
                            ...
                            <div className="text-[13px] text-black/50">
                                ...
                                déjà inscrit{waitlistCount > 1 ? "s" : ""}
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="relative">
                            ...
                            >
                                <div className="group/badge p-3 rounded-2xl bg-white border border-black/10 shadow-xl backdrop-blur-xl hover:shadow-2xl hover:scale-110 transition-all duration-300 cursor-pointer">
                                    <div className="flex items-center gap-2">
                                        <Sparkles
                                            className="w-4 h-4 text-black group-hover/badge:rotate-12 transition-transform duration-300"
                                            strokeWidth={2}
                                        />
                                        <span className="text-[11px] font-semibold text-black">
                                            IA Activée
