                    ...
                    <>
                        <DialogHeader>
                            ...
                            <DialogDescription className="text-[14px] text-black/60">
                                Donnez acc�s au portail client �{" "}
                        ...
                        <div className="space-y-4 py-4">
                            ...
                            <div className="rounded-lg bg-black/5 p-4">
                                <p className="text-[13px] text-black/60">
                                    ...
                                    Le client pourra le modifier apr�s sa premi�re connexion.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4 py-4">
                            ...
                            <div className="rounded-lg bg-black/5 p-4">
                                <p className="text-[13px] text-black/60">
                                    ...
                                    affich� apr�s la fermeture de cette fen�tre.
                                </p>
                            </div>
                        </div>
