    ...
    <Card className="group relative overflow-hidden border-black/[0.08] bg-white hover:shadow-lg hover:shadow-black/5 transition-all duration-500">
      ...
      <div className="relative p-6">
        ...
        <div className="space-y-3">
          {clients.map((client) => (
            <Card key={client.id} className="group/item relative overflow-hidden border-black/[0.08] bg-white hover:shadow-md hover:shadow-black/5 transition-all duration-300">
                    ...
                    <div className="space-y-2 mb-3">
                      {client.email && (
                        <div className="flex items-center gap-2.5">
                          ...
                          <p className="text-[13px] text-black/70">{client.email}</p>
                        </div>
                      )}
                      {client.telephone && (
                        <div className="flex items-center gap-2.5">
