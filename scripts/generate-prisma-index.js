...
const PRISMA_OUTPUT_DIR = path.join(
    __dirname,
    "..",
    "lib",
    "generated",
...
*
* ⚠️ This file exports from 'browser.ts' to be compatible with client components.
* For server-side usage with PrismaClient, import from '@/lib/prisma' instead.
*/

// Re-export browser-safe types (no Node.js imports)
export * from './browser';
...
try {
    ...
    if (!fs.existsSync(PRISMA_OUTPUT_DIR)) {
        console.error(
            `Error: Prisma output directory not found at ${PRISMA_OUTPUT_DIR}`
        );
