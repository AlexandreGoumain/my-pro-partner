...
export async function GET(_req: NextRequest) {
    return withApiHandler(
            ...
            if (entreprise.subscription?.stripeCustomerId) {
                try {
                    const customer = await stripe.customers.retrieve(
                        entreprise.subscription.stripeCustomerId
                    );
                    ...
                    subscription: entreprise.subscription
                        ? {
                              ...
                              stripeSubscriptionId:
                                  entreprise.subscription.stripeSubscriptionId,
        ...
        {
            context: { resourceName: "Subscription", operation: "debug" },
        }
    );
}
