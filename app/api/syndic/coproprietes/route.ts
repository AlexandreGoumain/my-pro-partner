...
export async function GET(request: NextRequest) {
    return withApiHandler(
        ...
        },
        {
            ...
            context: { resourceName: "Copropriete", operation: "list" },
        }
    );
}

/**
 * POST /api/syndic/coproprietes
    ...
    return withApiHandler(
        async (ctx) => {
            ...
            if (!body.nom || !body.adresse || !body.codePostal || !body.ville) {
                throw new ValidationError("Nom, adresse, code postal et ville requis");
            }
        ...
        {
            anyCapability: ["coproprietes"],
            context: { resourceName: "Copropriete", operation: "create" },
        }
    );
}
